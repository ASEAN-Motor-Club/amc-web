...
<div class="radio-bg bg-cover bg-fixed bg-center">
  <CommonHead class="justify-center bg-black/70 text-white dark:bg-black/90"
...
<style>
  .radio-bg {
    background-image: url('$lib/assets/images/tire_tracks.avif');
  }
</style>
