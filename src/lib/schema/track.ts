...
export const trackSchema = z.object({
  routeName: z
    .string(siteLocale.msg['track_editor.validate.name_must_be_string']())
    .check(z.minLength(1, siteLocale.msg['track_editor.validate.name_empty']())),
  waypoints: z.array(waypointSchema).check(
    z.minLength(
      2,
      siteLocale.msg['track_editor.validate.waypoints_min_length']({
        minLength: 2,
      }),
    ),
    z.maxLength(
      50,
      siteLocale.msg['track_editor.validate.waypoints_max_length']({
        maxLength: 50,
      }),
    ),
  ),
